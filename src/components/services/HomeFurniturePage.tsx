...
interface HomeFurniturePageProps {
  service: ResidentialService;
}

const FURNITURE_TYPES = [
  { name: 'Living Room', description: 'Sofas, coffee tables, entertainment units', icon: Sofa },
  { name: 'Dining', description: 'Tables, chairs, sideboards', icon: TreePine },
  { name: 'Bedroom', description: 'Beds, wardrobes, nightstands', icon: Shield },
  { name: 'Storage', description: 'Cabinets, shelving, organizers', icon: Ruler },
];

const HomeFurniturePage = ({ service }: HomeFurniturePageProps) => {
    ...
    <main className="pt-20">
      <section className="relative">
        <div className="relative h-125 md:h-150 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-linear-to-t from-amber-950/90 via-amber-900/50 to-amber-800/20" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div>
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h2 className="text-3xl font-bold text-gray-900">
                  Bespoke Furniture Crafted for You
                </h2>
              </div>
              <p className="text-lg text-gray-600 leading-relaxed">
                Every piece of furniture we create tells a story — your story. From the initial sketch to the final polish, we combine time-honored craftsmanship with contemporary design to create pieces that fit your space perfectly. Whether it is a statement sofa for your living room or a custom dining table for family gatherings, our furniture is built to last generations.
              </p>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-amber-50/70 p-6 rounded-lg text-center border border-amber-100">
              <Ruler className="w-8 h-8 text-amber-700 mx-auto mb-3" />
              <h3 className="font-semibold text-gray-900 mb-2">Perfect Fit</h3>
              <p className="text-sm text-gray-600">Custom measurements for your exact space requirements</p>
            </div>

            <div className="bg-stone-50 p-6 rounded-lg text-center border border-stone-200">
              <TreePine className="w-8 h-8 text-stone-700 mx-auto mb-3" />
              <h3 className="font-semibold text-gray-900 mb-2">Premium Materials</h3>
              <p className="text-sm text-gray-600">Solid wood, genuine leather, quality fabrics</p>
            </div>

            <div className="bg-amber-50/50 p-6 rounded-lg text-center border border-amber-100">
              <Truck className="w-8 h-8 text-amber-800 mx-auto mb-3" />
              <h3 className="font-semibold text-gray-900 mb-2">White Glove Delivery</h3>
              <p className="text-sm text-gray-600">Professional placement and setup in your home</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 md:px-8 bg-stone-50">
        <div className="max-w-6xl mx-auto">
          <SectionHeading
            ...
            subtitle="Custom pieces designed for your lifestyle"
          />
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
            {FURNITURE_TYPES.map((type) => {
              const IconComponent = type.icon;
              return (
                <div key={type.name} className="bg-white p-8 rounded-2xl shadow-sm text-center hover:shadow-md transition-shadow">
                  <div className="w-16 h-16 bg-amber-100 rounded-2xl flex items-center justify-center mx-auto mb-5">
                    <IconComponent className="w-8 h-8 text-amber-700" />
                  </div>
                  <h3 className="font-semibold text-gray-900 mb-3 text-lg">{type.name}</h3>
      ...
      <section className="py-20 px-4 md:px-8 bg-linear-to-b from-amber-50 to-white">
        <div className="max-w-6xl mx-auto">
          <SectionHeading
            ...
            subtitle="Our furniture crafting journey"
          />
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
            {service.process.map((step, index) => (
              <div key={index} className="bg-white p-8 rounded-xl shadow-sm border border-amber-100/50">
      ...
      <section className="py-20 px-4 md:px-8 max-w-6xl mx-auto">
        <SectionHeading
          ...
          subtitle="Why our furniture stands apart"
        />
      ...
      <section className="py-20 px-4 md:px-8 bg-amber-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <Shield className="w-16 h-16 text-amber-400 mx-auto mb-6" />
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Lifetime Craftsmanship Guarantee</h2>
          <p className="text-lg text-amber-100/80 mb-8">
            Every piece we create is backed by our commitment to quality. We use time-tested joinery techniques and premium materials to ensure your furniture becomes a cherished heirloom.
          </p>
          <div className="flex flex-wrap justify-center gap-8 text-sm">
            ...
            <div className="flex items-center space-x-2">
              <CheckCircle className="w-5 h-5 text-amber-400" />
              <span>Hand-Rubbed Finishes</span>
            </div>
            <div className="flex items-center space-x-2">
              <CheckCircle className="w-5 h-5 text-amber-400" />
      ...
      <section className="py-20 px-4 md:px-8 bg-stone-50">
        <div className="max-w-6xl mx-auto">
          <SectionHeading
            ...
            subtitle="Custom pieces crafted for our clients"
          />
      ...
      <section className="py-20 px-4 md:px-8">
        <div className="max-w-4xl mx-auto bg-linear-to-br from-stone-800 to-amber-900 text-white rounded-3xl p-10 md:p-16 text-center">
          <Sofa className="w-14 h-14 text-amber-400 mx-auto mb-6" />
          <h2 className="text-3xl md:text-5xl font-bold mb-6">
            Let&apos;s Create Your Perfect Piece
          </h2>
