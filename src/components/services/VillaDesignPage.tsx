...
import { CheckCircle, ChevronLeft, ChevronRight, Home, Crown, Sparkles, Maximize, Gem, Building2 } from 'lucide-react';
...
interface VillaDesignPageProps {
  service: ResidentialService;
}

const VILLA_ELEMENTS = [
  { name: 'Spacious Layouts', description: 'Grand, flowing floor plans', icon: Maximize },
  { name: 'Premium Materials', description: 'Luxury finishes throughout', icon: Gem },
  { name: 'Elegant Design', description: 'Sophisticated aesthetics', icon: Crown },
  { name: 'Custom Features', description: 'Bespoke architectural details', icon: Building2 },
];

const VillaDesignPage = ({ service }: VillaDesignPageProps) => {
  ...
  return (
    <main className="pt-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div>
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h2 className="text-3xl font-bold text-gray-900">
                  Grand Spaces, Refined Living
                </h2>
              </div>
              <p className="text-lg text-gray-600 leading-relaxed">
                Villa living deserves extraordinary design. We create luxurious interiors that match the grandeur of your spacious home, emphasizing elegant layouts, premium materials, and bespoke details. From sweeping living areas to intimate retreats, every space is crafted to provide sophisticated comfort for discerning homeowners.
              </p>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-amber-50/70 p-6 rounded-lg text-center border border-amber-100">
              <Maximize className="w-8 h-8 text-amber-700 mx-auto mb-3" />
              <h3 className="font-semibold text-gray-900 mb-2">Spacious Design</h3>
              <p className="text-sm text-gray-600">Grand floor plans</p>
            </div>
            <div className="bg-yellow-50 p-6 rounded-lg text-center border border-yellow-100">
              <Gem className="w-8 h-8 text-yellow-700 mx-auto mb-3" />
              <h3 className="font-semibold text-gray-900 mb-2">Premium Materials</h3>
              <p className="text-sm text-gray-600">Luxury finishes</p>
            </div>
            <div className="bg-amber-50/50 p-6 rounded-lg text-center border border-amber-100">
              <Home className="w-8 h-8 text-amber-800 mx-auto mb-3" />
              <h3 className="font-semibold text-gray-900 mb-2">Custom Elements</h3>
              <p className="text-sm text-gray-600">Bespoke details</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 md:px-8 bg-amber-50">
        <div className="max-w-6xl mx-auto">
          <SectionHeading
            title="Villa Design Elements"
            subtitle="Creating luxurious living spaces"
          />
      ...
      <section className="py-20 px-4 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <SectionHeading
            ...
            subtitle="From vision to luxury reality"
          />
      ...
      <section className="py-20 px-4 md:px-8 max-w-6xl mx-auto">
        <SectionHeading
          title="Why Choose Our Villa Designs"
          subtitle="Excellence in luxury interiors"
        />
      ...
      <section className="py-20 px-4 md:px-8 bg-yellow-50">
        <div className="max-w-6xl mx-auto">
          <SectionHeading
            ...
            subtitle="Luxury homes we have designed"
          />
      ...
      <section className="py-20 px-4 md:px-8">
        <div className="max-w-4xl mx-auto bg-linear-to-br from-amber-900 to-yellow-900 text-white rounded-3xl p-10 md:p-16 text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-6">
            Create Your Dream Villa
          </h2>
          <p className="text-gray-300 max-w-2xl mx-auto mb-10 text-lg">
            Let us design a luxurious villa interior that matches the grandeur of your home and exceeds your expectations.
          </p>
...
export default VillaDesignPage;
