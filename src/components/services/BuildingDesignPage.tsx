...
import { CheckCircle, ChevronLeft, ChevronRight, Building2, HardHat, Ruler, FileText, Sparkles, Landmark, PenTool } from 'lucide-react';
...
interface BuildingDesignPageProps {
  service: ResidentialService;
}

const BUILDING_ELEMENTS = [
  { name: 'Architectural Plans', description: 'Detailed blueprints', icon: FileText },
  { name: 'Structural Design', description: 'Safe and sound', icon: HardHat },
  { name: 'Space Planning', description: 'Optimal layouts', icon: Ruler },
  { name: 'Aesthetic Vision', description: 'Stunning exteriors', icon: PenTool },
];

const BuildingDesignPage = ({ service }: BuildingDesignPageProps) => {
    ...
    <main className="pt-20">
      <section className="relative">
        <div className="relative h-125 md:h-150 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-linear-to-t from-slate-950/90 via-gray-950/50 to-zinc-900/20" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div>
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h2 className="text-3xl font-bold text-gray-900">
                  Architecture Meets Vision
                </h2>
              </div>
              <p className="text-lg text-gray-600 leading-relaxed">
                Great buildings start with great design. Our architectural team creates comprehensive building designs that balance aesthetics, functionality, and structural integrity. From initial concept to detailed construction documents, we ensure every aspect of your building is thoughtfully planned and beautifully executed.
              </p>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-slate-50/70 p-6 rounded-lg text-center border border-slate-200">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Blueprints</h3>
              <p className="text-sm text-gray-600">Detailed plans</p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg text-center border border-gray-200">
              <HardHat className="w-8 h-8 text-gray-700 mx-auto mb-3" />
            ...
            <div className="bg-slate-50/50 p-6 rounded-lg text-center border border-slate-200">
              <Ruler className="w-8 h-8 text-slate-800 mx-auto mb-3" />
              <h3 className="font-semibold text-gray-900 mb-2">Precision</h3>
              <p className="text-sm text-gray-600">Accurate measurements</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <SectionHeading
            ...
            subtitle="From concept to construction"
          />
      ...
      <section className="py-20 px-4 md:px-8 max-w-6xl mx-auto">
        <SectionHeading
          title="Why Choose Our Building Design"
      ...
      <section className="py-20 px-4 md:px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <SectionHeading
            title="Featured Building Projects"
            subtitle="Structures we have designed"
          />
      ...
      <section className="py-20 px-4 md:px-8">
        <div className="max-w-4xl mx-auto bg-linear-to-br from-slate-800 to-gray-900 text-white rounded-3xl p-10 md:p-16 text-center">
          <Building2 className="w-14 h-14 text-slate-400 mx-auto mb-6" />
          <h2 className="text-3xl md:text-5xl font-bold mb-6">
            Design Your Dream Building
          </h2>
          <p className="text-gray-300 max-w-2xl mx-auto mb-10 text-lg">
            Let our architects bring your vision to life with innovative, functional, and beautiful building designs.
          </p>
          <Button href="/contact" className="bg-white text-slate-900 hover:bg-gray-100" size="lg">
            Start Your Building Design Project
          </Button>
        </div>
      </section>
    </main>
