...
import { CheckCircle, ChevronLeft, ChevronRight, Sofa, Tv, Users, Heart, Sparkles, Home, Flame } from 'lucide-react';
...
const LIVING_ELEMENTS = [
  { name: 'Comfortable Seating', description: 'Cozy sofas and chairs', icon: Sofa },
  { name: 'Entertainment', description: 'TV and media integration', icon: Tv },
  { name: 'Family Space', description: 'Gathering for everyone', icon: Users },
  { name: 'Warm Atmosphere', description: 'Inviting ambiance', icon: Flame },
];

const LivingRoomPage = ({ service }: LivingRoomPageProps) => {
    ...
    <main className="pt-20">
      <section className="relative">
        <div className="relative h-125 md:h-150 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-linear-to-t from-orange-950/90 via-amber-950/50 to-yellow-900/20" />
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12 text-white">
            <div className="max-w-6xl mx-auto">
              <div className="flex items-center space-x-2 mb-3">
                <Sofa className="w-5 h-5 text-orange-400" />
          ...
          <div className="lg:col-span-2 space-y-8">
            <div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                The living room is where life happens — movie nights, family gatherings, quiet mornings with coffee. We design living spaces that balance comfort with style, creating environments that welcome relaxation while reflecting your personality. From entertainment integration to cozy seating arrangements, we create the perfect backdrop for your family life.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-6">
              ...
              {service.duration && (
                <div className="bg-amber-50 px-6 py-4 rounded-lg border border-amber-100">
                  ...
                  <p className="text-xl font-bold text-amber-700">{service.duration}</p>
                </div>
              )}
            </div>
      ...
      <section className="py-20 px-4 md:px-8 bg-orange-50">
        <div className="max-w-6xl mx-auto">
          <SectionHeading
            ...
            subtitle="Creating perfect family spaces"
          />
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
            {LIVING_ELEMENTS.map((element) => {
      ...
      <section className="py-20 px-4 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <SectionHeading
            ...
            subtitle="From concept to family hub"
          />
      ...
      <section className="py-20 px-4 md:px-8 max-w-6xl mx-auto">
        <SectionHeading
          title="Why Choose Our Living Rooms"
          subtitle="Comfort, style, and functionality"
        />
      ...
      <section className="py-20 px-4 md:px-8 bg-amber-50">
        <div className="max-w-6xl mx-auto">
          <SectionHeading
            title="Featured Living Room Projects"
            subtitle="Family spaces we have created"
          />
      ...
      <section className="py-20 px-4 md:px-8">
        <div className="max-w-4xl mx-auto bg-linear-to-br from-orange-900 to-amber-900 text-white rounded-3xl p-10 md:p-16 text-center">
          <Home className="w-14 h-14 text-orange-400 mx-auto mb-6" />
          <h2 className="text-3xl md:text-5xl font-bold mb-6">
            Create Your Perfect Living Room
          </h2>
          <p className="text-gray-300 max-w-2xl mx-auto mb-10 text-lg">
            Let us design a living space that brings your family together in comfort and style.
          </p>
          <Button href="/contact" className="bg-white text-orange-900 hover:bg-gray-100" size="lg">
            Start Your Living Room Project
          </Button>
        </div>
      </section>
    </main>
